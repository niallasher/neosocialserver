...
class LegacyUser(Resource):
    ...
    def get(self):
        ...
        parser.add_argument("disable_include_images", type=str,
    ...
    def delete(self):
        ...
        if verify_password_valid(args['password'], user.password_salt, user.password_hash):
            user.delete()
            return {}, 201
        else:
            return {}, 401
    ...
    def post(self):
        ...
        parser.add_argument('username', type=str, help="Username for created account", required=True)
        parser.add_argument('password', type=str, help="Password for created account", required=True)
        parser.add_argument('display_name', type=str, help="Display name for created account", required=True)
